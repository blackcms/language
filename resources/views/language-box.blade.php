...
@if (count($languages) > 1)
    <div><strong>{{ trans('addons/language::language.translations') }}</strong>
    ...
    {!! Form::modalAction('confirm-change-language-modal', trans('addons/language::language.confirm-change-language'), 'warning', trans('addons/language::language.confirm-change-language-message'), 'confirm-change-language-button', trans('addons/language::language.confirm-change-language-btn')) !!}
@endif
